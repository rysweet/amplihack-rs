pub(in crate::cli_memory::code_graph) const GRAPH_CODE_GRAPH_SCHEMA: &[&str] = &[
...
pub(in crate::cli_memory::code_graph) const GRAPH_MEMORY_FILE_LINK_TABLES: &[(&str, &str)] = &[
...
pub(in crate::cli_memory::code_graph) const GRAPH_MEMORY_FUNCTION_LINK_TABLES: &[(&str, &str)] = &[
