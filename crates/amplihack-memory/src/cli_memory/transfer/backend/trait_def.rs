use super::super::*;
use crate::cli_memory::BackendChoice;
use anyhow::Result;

/// Maximum allowed JSON file size for graph-db imports: 500 MiB.
/// Mirrors the same guard in the SQLite backend.
pub(in crate::cli_memory::transfer) const MAX_JSON_FILE_SIZE: u64 = 500 * 1024 * 1024;

pub(in crate::cli_memory::transfer) trait HierarchicalTransferBackend {
...
pub(in crate::cli_memory::transfer) struct GraphDbHierarchicalTransferBackend;

pub(in crate::cli_memory::transfer) fn open_hierarchical_transfer_backend_for(
...
pub(in crate::cli_memory::transfer) fn export_hierarchical_json(
    agent_name: &str,
    output: &str,
    storage_path: Option<&str>,
    choice: BackendChoice,
...
pub(in crate::cli_memory::transfer) fn import_hierarchical_json(
    agent_name: &str,
    input: &str,
    merge: bool,
    storage_path: Option<&str>,
...
pub(in crate::cli_memory::transfer) fn export_hierarchical_raw_db(
    agent_name: &str,
    output: &str,
    storage_path: Option<&str>,
    choice: BackendChoice,
...
pub(in crate::cli_memory::transfer) fn import_hierarchical_raw_db(
    agent_name: &str,
    input: &str,
    merge: bool,
    storage_path: Option<&str>,
