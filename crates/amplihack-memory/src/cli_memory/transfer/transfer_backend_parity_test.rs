...
use crate::cli_memory::transfer::backend::open_hierarchical_transfer_backend_for;
use crate::cli_memory::transfer::{HierarchicalExportData, HierarchicalStats, ImportResult};
...
fn import_json_round_trip_sqlite() -> anyhow::Result<()> {
    ...
    let data = HierarchicalExportData {
        ...
        exported_at: "1704067200".to_string(),
        format_version: "1.1".to_string(),
        semantic_nodes: vec![crate::cli_memory::transfer::SemanticNode {
...
fn assert_derives_from_edge_preserved(choice: BackendChoice) -> anyhow::Result<()> {
    ...
    let data = HierarchicalExportData {
        ...
        episodic_nodes: vec![crate::cli_memory::transfer::EpisodicNode {
        ...
        similar_to_edges: vec![],
        derives_from_edges: vec![crate::cli_memory::transfer::DerivesEdge {
