...
pub fn generate_report(
    ...
    // Overall = 0.4 * quality + 0.3 * reliability + 0.3 * performance
...
mod tests {
    ...
    fn generate_report_empty_data() {
        ...
        // Empty logs default to 1.0 success rate
        assert_eq!(report.reliability.store_success_rate, 1.0);
    }
}
