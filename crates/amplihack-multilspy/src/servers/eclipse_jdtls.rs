//! Eclipse JDT.LS (Java) language server integration.
...
pub struct EclipseJdtlsServer {
    config: MultilspyConfig,
    root_path: PathBuf,
    client: Option<LspClient>,
}

impl EclipseJdtlsServer {
...
#[async_trait]
impl LanguageServer for EclipseJdtlsServer {
...
mod tests {
    ...
    fn initialize_params() {
        let server = EclipseJdtlsServer::new(
            MultilspyConfig::new(Language::Java),
            PathBuf::from("/home/user/java-app"),
        );
