//! gopls (Go language server) integration.
...
impl LanguageServer for GoplsServer {
    async fn start(&mut self) -> Result<()> {
        ...
        // gopls is ready immediately after initialize.
        info!("gopls ready");
