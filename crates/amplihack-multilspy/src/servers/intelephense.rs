//! Intelephense (PHP) language server integration.
...
pub struct IntelephenseServer {
    config: MultilspyConfig,
    root_path: PathBuf,
    client: Option<LspClient>,
}

impl IntelephenseServer {
...
#[async_trait]
impl LanguageServer for IntelephenseServer {
