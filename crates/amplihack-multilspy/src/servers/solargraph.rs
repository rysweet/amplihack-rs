//! Solargraph (Ruby) language server integration.
...
pub struct SolargraphServer {
    config: MultilspyConfig,
    root_path: PathBuf,
    client: Option<LspClient>,
}

impl SolargraphServer {
...
#[async_trait]
impl LanguageServer for SolargraphServer {
...
mod tests {
    ...
    fn initialize_params() {
        let server = SolargraphServer::new(
            MultilspyConfig::new(Language::Ruby),
            PathBuf::from("/projects/ruby-app"),
        );
