...
!!! note "Python examples"
    The code examples in this document show the upstream Python API to illustrate
    architectural patterns. They are not amplihack-rs-specific tooling.
...
1. Graph database setup (e.g., Neo4j or FalkorDB)
2. Vector store integration (e.g., Qdrant or pgvector)
...
- [Agent Memory Architecture](agent-memory-architecture.md) - amplihack-rs memory system overview
- [Memory Backend Architecture](memory-backend-architecture.md) - Backend design details
- [Memory Backend Migration](memory-backend-migration.md) - Migration guide for memory backends
- [Memory-OODA Integration](memory-ooda-integration.md) - OODA loop design with memory
- [Goal-Seeking Agents](goal-seeking-agents.md) - Goal-seeking agent patterns
- [Philosophy](philosophy.md) - Core design principles
- [Patterns](patterns.md) - Existing pattern catalog
