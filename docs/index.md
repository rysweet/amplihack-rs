...
- [Run in Non-Interactive Mode](./howto/run-in-noninteractive-mode.md) — Use amplihack in CI pipelines, Docker, and scripted environments without a terminal
...
- [Environment Variables](./reference/environment-variables.md) — Every environment variable the launcher reads or injects, including AMPLIHACK_AGENT_BINARY, AMPLIHACK_HOME, and AMPLIHACK_NONINTERACTIVE
...
- [Agent Binary Routing](./concepts/agent-binary-routing.md) — How AMPLIHACK_AGENT_BINARY propagates the chosen AI tool through the launcher and recipe runner
