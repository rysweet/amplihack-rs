...
- [Dev-Orchestrator Routing Contract](reference/dev-orchestrator-routing.md) - Deterministic routing rules for Development and hybrid workstreams
- [Verify Dev-Orchestrator Routing](howto/verify-dev-orchestrator-routing.md) - Check Development-to-default-workflow normalization from the CLI
