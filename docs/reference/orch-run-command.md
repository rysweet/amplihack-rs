...
| `recipe`          | string          | no       | Per-workstream recipe after deterministic normalization. `Development` workstreams always use `default-workflow`; see [Dev-Orchestrator Routing Contract](./dev-orchestrator-routing.md) |
